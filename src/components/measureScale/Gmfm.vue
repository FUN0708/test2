<template>
  <div>
    <el-row>
      <el-col :span="4" style="margin-top: 10px; color: #4b8bea;">GMFM量表检测项目</el-col>
      <el-col :span="4" style="margin-top: 8px; color: #4b8bea;">类别：</el-col>
<!--      <el-col :span="7">-->
<!--        &lt;!&ndash; 搜索与添加区域 &ndash;&gt;-->
...
<!--        </el-input>-->
<!--      </el-col>-->
      <el-col :span="10" style="margin-top: 10px; color: #4b8bea;">
...
<!--    </div>-->
    ...
    <el-table :data="projectList" style="width: 100%">
      <el-table-column type="expand">
        <template v-slot="props" >
          <el-form label-position="left" inline class="demo-table-expand" style="margin-left: 5%">
            ...
            <el-form-item label="评分3:"  style="width: 100%">
              <span>{{ props.row.s3 }}</span>
            </el-form-item>
          </el-form>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="s3" label="评分3" v-if="false"></el-table-column>
    </el-table>
  </div>
</template>
  ...
  methods: {
    ...
    getProjectByType(val) {
      ...
      if(this.labels.length == 0) {
        ...
        axios.post("/gmfm/getProjectByType?type="+this.labels, {
          // type: this.labels
        }).then(resp =>
          this.projectList = resp.data)
        this.labels = ""
